...
if __name__ == '__main__':
    base_dir = "c:\\Users\\Admin\\Desktop\\CUMCM2025-C\\CUMCM2025-C"
    source_data_dir = os.path.join(base_dir, "Source_DATA")
    processed_data_dir = os.path.join(base_dir, "Processed_DATA")

    data_a_path = os.path.join(source_data_dir, 'dataA.csv')
    data_b_path = os.path.join(source_data_dir, 'dataB.csv')
    output_file_path = os.path.join(processed_data_dir, 'cleaned_fetal_data.csv')
