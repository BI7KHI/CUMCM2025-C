...
if __name__ == '__main__':
    ...
    data_a_path = os.path.join(project_root, 'Source_DATA', 'dataA.csv')
    data_b_path = os.path.join(project_root, 'Source_DATA', 'dataB.csv')
    output_dir = os.path.join(scripts_dir, 'processed_data')
